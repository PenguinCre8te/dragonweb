...
/** @type {string} */
const CACHE_VERSION = '1778022916|45060165';
/** @type {string} */
const CACHE_PREFIX = 'dragonfinal-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'dragon.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["dragon.html","dragon.js","dragon.offline.html","dragon.icon.png","dragon.apple-touch-icon.png","dragon.audio.worklet.js","dragon.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["dragon.wasm","dragon.pck"];
